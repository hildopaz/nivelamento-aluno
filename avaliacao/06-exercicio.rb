...
#de registros de mortes diária por covid e o número de dias de intervalo para calcular as médias. Essa função deve retornar um novo array sendo que 
#o valor de cada elemento é a média de mortes com base no número de dias de intervalo informado no segundo parâmetro.
...
def calcula_media_movel(registro_mortes_diaria, dias_intervalo)
